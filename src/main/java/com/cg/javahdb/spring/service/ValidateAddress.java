...
public class ValidateAddress {
	...
	public String bingValidation(AddressTemplate address)
	{
		...
		String url = String.format(config.getHereApiEndpoint(),"472+21st+B%20Cross+Road+MRS+LAYOUT+BANGALORE+560091");
	...
	{
		String url = "https://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/findAddressCandidates?Address=475+21st+B+CRossRoad&City=Bangalore&Region=Karnataka&Postal=560091&Country=India&outFields=*&forStorage=false&f=json";
